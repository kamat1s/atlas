...
import 'package:atlas/Classes/NotificationController.dart';
import 'package:atlas/Screens/Verification/verification.dart';
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        const Verification(accountType: 'patient'),
                  )).then((value) {
                if (value) {
        ...
        body: StreamBuilder(
            ...
            builder: (context, snapshot) {
              ...
              Stream<QuerySnapshot<Map<String, dynamic>>>
                  verificationRequestStream = const Stream.empty();
              ...
              return Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Visibility(
                      visible: !currentUser.isAnonymous,
                      child: Padding(
                      ...
                      onTap: () async {
                        ...
                        if (currentUser.isAnonymous) {
                       ...
                       else
                         {
                           ...
                           await getData("${accountType}s", uid: uid, field: "token")
                               .then((token) {
                             print(token);
