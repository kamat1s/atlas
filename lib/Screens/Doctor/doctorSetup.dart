...
class DoctorSetup extends StatefulWidget {
  const DoctorSetup({Key? key}) : super(key: key);
...
class _DoctorSetupState extends State<DoctorSetup> {
  ...
  final typeOfDoctorController = TextEditingController();
  ...
  bool typeOfDoctorSelected = false;
  ...
  List<String> description = [
    ...
    "Your Services and Accreditations",
    "Upload Medical License to verify your account",
    "Setup Summary"
  ];
  ...
  editTime(int index, var setState, {String timeOf = "clinic"}) {
    //TODO: restrict doctors available time within clinic hours
    //TODO: fix bug (revert to prev time when edit closed)
    showDialog<void>(
      useSafeArea: true,
      context: context,
      builder: (BuildContext context) {
                        ...
                        Padding(
                          ...
                          child: Focus(
                            ...
                            child: TextFormField(
                              ...
                              autovalidateMode:
                                  AutovalidateMode.onUserInteraction,
                              validator: (typeOfDoctor) =>
                                  typeOfDoctor != null &&
                                          typeOfDoctor.trim().isEmpty
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 15),
                        child: Text(
                          "Own clinic/office if any (optional):",
                          style: theme.textTheme.bodyMedium?.copyWith(
                            fontWeight: FontWeight.w700,
                          ),
                        ),
                          ...
                          child: Container(
                            ...
                            child: Stack(
                              children: [
                                ...
                                Padding(
                                  padding:
                                      const EdgeInsets.fromLTRB(35, 20, 35, 0),
                                  child: Focus(
                                    onFocusChange: (hasFocus) => setState(() {
                                    ...
                                    child: TextFormField(
                                      ...
                                      autovalidateMode: addressController
                                              .text.isEmpty
                                          ? AutovalidateMode.onUserInteraction
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(
                        "Dr. ${firstNameController.text}${middleNameController.text.isNotEmpty ? " ${middleNameController.text} " : " "}${lastNameController.text}",
                        style: theme.textTheme.labelMedium,
                      ),
                    ],
                  ),
                                              ...
                                              if (step < 6) {
                                                if (step == 1 &&
                                                  ...
                                                  if (step == 1) {
                                                    ...
                                                    errorMessage =
                                                        "Please select your Working Schedule first.";
                                                  } else if (step == 4) {
                                                    errorMessage =
                                                        "Please select your services first.";
                                                  }
                                          ...
                                          onPressed: () async {
                                            ...
                                            if (step == 5) {
                                              if (pickedFiles!.isNotEmpty) {
                                                ...
                                                var errorMessage =
                                                    "Please upload medical license first.";
                                                showSnackBar(errorMessage);
                                              }
                                            } else {
                                              path =
                                                  "users/$uid/medical license/";
                                              ...
                                              doctorData['serviceHours'] =
                                                  clinicServiceHours;
                                              doctorData['services'] =
                                                  selectedServices;
                                              doctorData['accreditations'] =
                                                  clinicAccreditations;
                                              doctorData['setupDone'] = true;
                                              doctorData[
                                              ...
                                              await addNotification(
                                                  ...
                                                  body:
                                                      "Hey there! A doctor submitted a new Verification request. Review it Now!");

                                              setupAccount(doctorData,
                                                  "independentDoctor");
