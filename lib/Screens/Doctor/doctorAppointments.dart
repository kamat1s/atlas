...
class _DoctorAppointmentsState extends State<DoctorAppointments> {
  ...
  final Stream<QuerySnapshot> doctorAppointmentStream = FirebaseFirestore.instance
  ...
  showCompleteDialog(var doctorAppointmentID) {
    showDialog<String>(
      useSafeArea: true,
      context: context,
      builder: (BuildContext context) {
  ...
  showDismissDialog(var doctorAppointmentID) {
    showDialog<String>(
      useSafeArea: true,
      context: context,
      builder: (BuildContext context) {
          ...
          children: [
                                                        ...
                                                        onPressed: () {
                                                          showDismissDialog(
                                                              upcomingAppointments[
                                                                  index]['independentDoctorAppointmentID']);
                                                        },
                                                        child: Text(
                                                          "Dismiss",
                                                          style: textTheme
            ...
            Positioned(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  var patientsData = await getPatientTokens(accountType: "independentDoctor");
