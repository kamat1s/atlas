import 'package:atlas/Screens/Doctor/doctorServices.dart';
import 'package:atlas/Screens/Doctor/doctorWorkingHours.dart';
...
class _DoctorProfileState extends State<DoctorProfile> {
  Stream<QuerySnapshot<Map<String, dynamic>>> userDataStream = const Stream.empty();
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text("Expect your request will be reviewed in 2-3 working days.",
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const Verification(accountType: 'doctor'),
                  )).then((value){
                if(value){
            ...
            builder: (context, snapshot) {
              ...
              return Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text("Dr. ${userData['firstName']}${userData['middleName'].isNotEmpty ? " ${userData['middleName']} " : " "}${userData['lastName']}",
                    ...
                    Padding(
                        ...
                        child: StreamBuilder(
                            ...
                            builder: (context, snapshot) {
                              ...
                              var requestDetail = snapshot.data!.docs.first.data();
                    ...
                    GestureDetector(
                      onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const DoctorServices(),
                        ),
                      ),
                      child: Padding(
                        padding:
                    ...
                    GestureDetector(
                      onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const DoctorWorkingHours(),
                        ),
                      ),
                      child: Padding(
                        padding:
                    ...
                    GestureDetector(
                      onTap: () async {
                        ...
                        String accountType = 'independentDoctor';
