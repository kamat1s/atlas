...
class _ClinicHomeState extends State<ClinicHome> {
  ...
  late StreamSubscription clinicNotificationStream;

  Widget getPanel() {
    switch (panelSelected) {
      case 1:
        {
          return const ClinicAppointments();
        }
      case 2:
        {
          return const ClinicPending();
        }
      case 3:
        {
          return const ClinicProfile();
        }
      default:
        {
          return const Center();
  ...
  void initState() {
    ...
    clinicNotificationStream = FirebaseFirestore.instance
  ...
  @override
  void dispose() {
    clinicNotificationStream.cancel();
    super.dispose();
  }
