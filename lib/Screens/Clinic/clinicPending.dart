...
class ClinicPending extends StatefulWidget {
  const ClinicPending({Key? key}) : super(key: key);

  @override
  State<ClinicPending> createState() => _ClinicPendingState();
}

class _ClinicPendingState extends State<ClinicPending> {
  ...
  final Stream<QuerySnapshot> appointmentStream = FirebaseFirestore.instance
      .collection('clinicAppointments').where('clinicID', isEqualTo: userData["clinicID"])
                                          ...
                                          child: TextButton(
                                            onPressed: () {
                                              Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                  builder: (context) =>
                                                      AppointmentReview(appointmentDetails: pendingAppointments[index], accountType: 'clinic'),
                                                ),
                                              );
                                            },
                                            child: Text(
