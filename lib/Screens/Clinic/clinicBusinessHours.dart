...
class ClinicBusinessHours extends StatefulWidget {
  const ClinicBusinessHours({Key? key}) : super(key: key);

  @override
  State<ClinicBusinessHours> createState() => _ClinicBusinessHoursState();
}

class _ClinicBusinessHoursState extends State<ClinicBusinessHours> {
  ...
  final Stream<QuerySnapshot<Map<String, dynamic>>> clinicDataStream =
              ...
              children: [
                StreamBuilder(
                  ...
                  builder: (context, snapshot) {
                    ...
                    clinicInformation = snapshot.data!.docs.first.data();
                              ...
                              children: [
                                ...
                                Checkbox(
                                  ...
                                  onChanged: (value) async {
                                    ...
                                    bool dayHasAppointment = await checkDateWithAppointment(ID: userData['clinicID'], accountType: "clinic", day: day);

                                    if(dayHasAppointment){
                                      showCannotDeleteInfoPrompt();
                                    }
                                    else if(availableDaysCounter > 1 || value == true){
                                      setState(() {
                                        availableDays[day] = value!;
                                      });
                                    }
                                    else{
                                      showSnackBar("You must provide at least one working hour.");
                                    }
  ...
  updateServiceHours() async {
    ...
    clinicInformation['serviceHours'] = newServiceHours;

    await updateData('clinics', clinicInformation, uid: uid);
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.only(top: 10),
                    child: Text(
                        "This business hour can’t be deleted because it has appointments that are still active.",
                        style: Theme.of(context).textTheme.bodyMedium?.copyWith(
