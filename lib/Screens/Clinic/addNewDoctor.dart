...
class _AddNewDoctorState extends State<AddNewDoctor> {
                    ...
                    child: Row(
                      children: [
                        ...
                        GestureDetector(
                          onTap: () async {
                            setState(() {
                              invalidName = doctorNameController.text.isEmpty;
                              noAvailableDays = noAvailableDays =
                              !doctorInformation['availableDays']
                                  .containsValue(true);
                              noSpecializations = specializations.isEmpty;
                            });
                            ...
                            if (!invalidName &&
                              ...
                              List<Map<String, dynamic>> updatedServiceHours =
                                  [];

                              for (var serviceHour in data['serviceHours']) {
                                if (data['availableDays'][serviceHour['day']]) {
                                  updatedServiceHours.add(serviceHour);
                                }
                              }

                              data['serviceHours'] = updatedServiceHours;
  ...
  Widget doctorSpecializationsWidget() => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Stack(
            children: [
  ...
  Widget emptySpecializationWidget() =>  Stack(
    children: [
      Padding(
        padding: const EdgeInsets.only(top: 15),
        child: Row(
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    "Hey Doc! Are you sure you want to Save New Doctor Information?",
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodyMedium
                                        ?.copyWith(
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextButton(
                                        onPressed: () async {
                                          List doctorsID = await addDoctors([data], clinicInformation['clinicID']);

                                          clinicInformation['doctors'].add(doctorsID.first);
